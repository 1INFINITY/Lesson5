package ru.mirea.ivashechkinav.audiorecord
...
import ru.mirea.ivashechkinav.audiorecord.databinding.ActivityMainBinding
import java.io.File
...
class MainActivity : AppCompatActivity() {
    ...
    private fun initButtons() {
        ...
        binding.btnStartRecord.setOnClickListener {
            if (isStartRecording) {
                binding.btnStartRecord.text = "Stop recording";
                binding.btnPlay.isEnabled = false;
                startRecording()
            } else {
                binding.btnStartRecord.text = "Start recording";
